...
#ifndef NIX_TESTDIMENSIONFS_HPP
#define NIX_TESTDIMENSIONFS_HPP

#include "BaseTestDimension.hpp"

class TestDimensionFS : public BaseTestDimension {

    CPPUNIT_TEST_SUITE(TestDimensionFS);
...
public:
    void setUp() {
        file = nix::File::open("test_dimension", nix::FileMode::Overwrite, "file");
